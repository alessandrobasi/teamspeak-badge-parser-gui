...
class MainWindow(QMainWindow):
    ...
    def getFile(self, local=None):
        ...
        with open("list", "r", encoding="ansi") as f:
            text = f.read()
        regex = r"^\$(?P<headid>[\w\d-]+)\x12(.|\n)(?P<nome>.+)\x1A.(?P<url>https://[\w\-\.\/]+)\x22\W(?P<desc>\w.*)\(.+$"
    ...
    def showBadgesInfo(self):
        uuid, nome, url, desc = self.tabellaBages.selectedItems()[0].data(Qt.UserRole)
        ...
        self.detailsSvgUrl.setText("Details SVG: <a href='"+url+"_details.svg"+"'>"+url+"_details.svg"+"</a>")
        self.detailsPngUrl.setText("Details PNG: <a href='"+url+"_64.png"+"'>"+url+"_64.png"+"</a>")
        self.pngUrl.setText("PNG: <a href='"+url+"_16.png"+"'>"+url+"_16.png"+"</a>")
    ...
    def mainWin(self):
        ...
        for row, badge in enumerate(self.badges):
            ...
            item = QTableWidgetItem(QIcon(self.getBadgeIcon(uuid, url, "_64")), nome)
